			...
			boolean flag = Db.tx(new IAtom() {
				...
				public boolean run() throws SQLException {
					...
					if (pm.equals("ccstlngdg")) {
						return UtilsPuMonth.savedata1("ccstlngdg", "dg_ccst_qpreginfo", "ccst_czlist", "dg_ccst_qpczlist", zcdm, "1",
								times);
					} else {
						return UtilsPuMonth.savedata1(Utils.getDb(codes), "ccst_qpreginfo", "ccst_czlist", "ccst_qpczlist", zcdm,
								"1", times);
					}
				}
			});
